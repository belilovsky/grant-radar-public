...
COPY: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "description": "Срез открытых программ поддержки для Казахстана: направления, сроки и источники.",
        "back": "Вернуться в каталог",
        "eyebrow": "Картина каталога",
        "heading": "Куда сейчас направлена поддержка",
        "intro": "Сводка по открытым возможностям из тех же проверяемых источников, которые используются в каталоге.",
        ...
        "formats_note": "Какие инструменты чаще всего встречаются в текущей выдаче.",
        "sources_title": "Кто публикует возможности",
        "sources_note": "Источники с наибольшим числом активных карточек.",
        "deadlines": "Распределение по срокам",
        "deadlines_note": "Срок помогает понять, что открыть в первую очередь.",
        "freshness": "Состояние источников",
        "freshness_note": "Свежесть проверяется по последнему успешному обновлению.",
        ...
        "method_text": "Это не рейтинг доноров и не прогноз объёма финансирования. Графики показывают только опубликованные карточки, которые сейчас проходят публичный фильтр QAZ.FUND.",
        "source_link": "Проверить источники",
        "catalog_link": "Открыть каталог",
        "no_data": "Данных для этого среза пока недостаточно.",
        "footer": "QAZ.FUND не выдаёт гранты и не принимает заявки. Окончательные условия проверяйте у организатора.",
    },
    "en": {
        "title": "Catalog insights – QAZ.FUND",
        "description": "A public view of support programs for Kazakhstan: formats, deadlines, and sources.",
        "back": "Back to catalog",
        "eyebrow": "Catalog view",
        "heading": "Where support is available now",
        "intro": "A compact view of open opportunities from the same checkable sources used by the catalog.",
        "total": "Open programs",
        "sources": "Official sources",
        "soon": "Deadline within 30 days",
        "rolling": "Programs without a fixed deadline",
        "formats": "Support formats",
        "formats_note": "The instruments most common in the current public set.",
        "sources_title": "Who publishes the opportunities",
        "sources_note": "Sources with the largest number of active cards.",
        "deadlines": "Deadline distribution",
        "deadlines_note": "Deadlines show what is worth opening first.",
        "freshness": "Source health",
        "freshness_note": "Freshness uses the latest successful update.",
        "high": "High match",
        "good": "Good match",
        "base": "Base match",
        ...
        "method_text": "This is not a donor ranking or a funding forecast. The charts show published cards that currently pass the QAZ.FUND public filter.",
        "source_link": "Check sources",
        "catalog_link": "Open catalog",
        "no_data": "There is not enough data for this view yet.",
        "footer": "QAZ.FUND does not award grants or accept applications. Check final terms with the organizer.",
    },
}
...
<head>
  ...
  <style>
    ...
    *{{box-sizing:border-box}} body{{margin:0;background:var(--color-bg);color:var(--color-text);font-family:var(--av-font-sans);line-height:1.5}}
    ...
    .hero-actions{{display:flex;gap:10px;flex-wrap:wrap;margin-top:20px}} .button{{display:inline-flex;align-items:center;min-height:38px;padding:0 14px;border-radius:var(--av-radius-md);border:1px solid var(--color-border);font-size:14px;font-weight:750;text-decoration:none;background:var(--color-surface)}} .button.primary{{background:var(--color-accent);border-color:var(--color-accent);color:#fff}}

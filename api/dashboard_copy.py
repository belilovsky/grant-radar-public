...
COPY = {
    "ru": {
        "lang": "ru",
        "locale": "ru-KZ",
        "title": "QAZ.FUND – каталог программ поддержки для Казахстана",
        "meta_description": (
            "Гранты, субсидии, акселераторы, тендеры и другие программы поддержки "
            "для Казахстана: фильтры, сроки и ссылка на условия организатора."
        ),
        "eyebrow": "Каталог программ поддержки для Казахстана",
        "headline": "QAZ.FUND",
        "subtitle": (
        ...
        "hero_intro": (
            "Гранты, субсидии, акселераторы и закупки: источник, статус и срок "
            "у каждой карточки."
        ),
        "hero_primary_cta": "Найти поддержку",
        "hero_stage_eyebrow": "В три шага",
        "hero_stage_title": "Уточните задачу",
        ...
        "hero_picks_label": "Быстрые фильтры",
        "hero_pick_startup": "Стартапам",
        "hero_pick_business": "Поиск по названию",
        "hero_pick_farmer": "Сроки до месяца",
        "hero_pick_science": "Программы в Казахстане",
        "hero_pick_tenders": "Тендеры и закупки",
        "spotlight_section_eyebrow": "Начните с задачи",
        "spotlight_section_title": "Подборки для первого поиска",
        "spotlight_section_description": (
            "Открытые программы для Казахстана, меры поддержки и ближайшие сроки "
            "без смешения с архивом."
        ),
        ...
        "spotlight_trending_kicker": "Открытые сейчас",
        "spotlight_trending_title": "С чего начать проверку",
        "spotlight_trending_note": (
            "Карточки с открытым статусом и заполненными ключевыми полями."
        ),
        ...
        "opportunities_description": (
            "Открытые и бессрочные программы, доступные заявителям из Казахстана "
            "и Центральной Азии."
        ),
        ...
        "trust_library_summary": "Источники и обновление",
        "trust_library_description": "Покрытие каталога, даты проверки и правила отбора.",
        ...
        "methodology_title": "Как проверить карточку",
        "methodology_description": (
            "Карточка показывает источник, дату и недостающие поля. Решение о "
            "подаче принимается по условиям организатора."
        ),
        ...
        "role_guide_title": "Для редакции и анализа",
        ...
        "profile_intro": (
            "Укажите тип заявителя, географию, формат поддержки и срок. Фильтры "
            "сохранятся в ссылке, чтобы к подборке можно было вернуться."
        ),
        ...
        "mobile_app_tagline": "Каталог программ поддержки",
        ...
        "footer_owner": "QAZ.FUND – открытый каталог программ поддержки. Сделано",
        "footer_disclaimer": (
        ...
        "signal_support_kz": (
            "Мера поддержки для команд и бизнеса в Казахстане; в карточке указан "
            "доступный порядок подачи."
        ),
        ...
        "detail_not_published": "Не указано организатором",
        "detail_organizer_label": "Организатор",
        "detail_geography_label": "География",
        "detail_eligibility_title": "Кому подходит",
        "detail_content_title": "Описание и условия",
        "detail_content_fallback_heading": "Подробности программы",
        "detail_guidance_title": "Что учесть",
        "detail_application_steps_title": "Как подать",
        "detail_source_title": "Официальный источник",
        "detail_reference_title": "Реквизиты публикации",
        ...
        "label_map": {
            ...
            "education_admission": "Приём на обучение",
            "state_funded_seat": "Место по госзаказу",
    ...
    "en": {
        ...
        "hero_stage_title": "Refine the task",
        ...
        "hero_picks_label": "Quick filters",
        "hero_pick_startup": "For startups",
        "hero_pick_business": "Search by name",
        "hero_pick_farmer": "Deadlines this month",
        "hero_pick_science": "Kazakhstan programs",
        ...
        "detail_not_published": "Not published by the organizer",
        "detail_organizer_label": "Organizer",
        "detail_geography_label": "Geography",
        "detail_eligibility_title": "Who it is for",
        "detail_content_title": "Description and terms",
        "detail_content_fallback_heading": "Program details",
        "detail_guidance_title": "What to note",
        "detail_application_steps_title": "How to apply",
        "detail_source_title": "Official source",
        "detail_reference_title": "Publication details",
        ...
        "label_map": {
            ...
            "education_admission": "Education admission",
            "state_funded_seat": "State-funded seat",
...
KK_DASHBOARD_COPY = {
    ...
    "hero_stage_title": "Міндетті нақтылаңыз",
    "hero_pick_startup": "Стартаптарға",
    "hero_pick_business": "Атауы бойынша іздеу",
    "hero_pick_farmer": "Осы айдағы мерзімдер",
    "hero_pick_science": "Қазақстандағы бағдарламалар",
    ...
    "headline": "QAZ.FUND",
    "hero_picks_label": "Жедел сүзгілер",
...
KK_PUBLIC_UI_COPY = {
    ...
    "detail_not_published": "Ұйымдастырушы көрсетпеген",
    "detail_organizer_label": "Ұйымдастырушы",
    "detail_geography_label": "География",
    "detail_eligibility_title": "Кімге арналған",
    "detail_content_title": "Сипаттама және шарттар",
    "detail_content_fallback_heading": "Бағдарлама туралы мәлімет",
    "detail_guidance_title": "Нені ескеру керек",
    "detail_application_steps_title": "Қалай өтінім беруге болады",
    "detail_source_title": "Ресми дереккөз",
    "detail_reference_title": "Жарияланым деректемелері",
    "detail_share": "Бөлісу",

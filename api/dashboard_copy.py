...
COPY = {
    "ru": {
        ...
        "eyebrow": "Навигатор программ поддержки",
        "headline": "QAZ.FUND",
        "subtitle": (
        ...
        "spotlight_section_description": (
            "Подборки по соответствию запросу, условиям для Казахстана и ближайшим "
            "срокам."
        ),
        ...
        "spotlight_trending_kicker": "Рекомендуем посмотреть",
        "spotlight_trending_title": "Подходящие программы",
        "spotlight_trending_note": (
            "Открытые программы с высоким соответствием запросу."
        ),
        "spotlight_kazakhstan_kicker": "Казахстан в приоритете",
        "spotlight_kazakhstan_title": "Программы для заявителей из Казахстана",
        "spotlight_kazakhstan_note": (
            "Гранты и программы, доступные в Казахстане или учитывающие местные условия."
        ),
        ...
        "spotlight_support_note": (
            "Субсидии, льготы и другие формы поддержки с конкретными условиями участия."
        ),
        "spotlight_deadline_kicker": "Скоро закрываются",
        "spotlight_deadline_title": "Ближайшие сроки",
        "spotlight_deadline_note": (
            "Программы, срок подачи по которым наступит раньше других."
        ),
        "pathways_section_eyebrow": "Для кого",
        "pathways_section_title": "По типу проекта",
        "pathways_section_description": (
            "Выберите тип заявителя – каталог покажет подходящие программы."
        ),
        ...
        "pathway_startup_note": (
            "Для технологических команд и молодых компаний, которым нужны "
            "финансирование, инфраструктура или опытное внедрение."
        ),
        "pathway_business_kicker": "Бизнесу",
        "pathway_business_title": "Субсидии, льготы и меры поддержки РК",
        "pathway_business_note": (
            "Для ИП, ТОО и действующего бизнеса, которому важны местные условия "
            "и правила подачи."
        ),
        "pathway_farmer_kicker": "Фермерам",
        "pathway_farmer_title": "Агро, животноводство и прикладные технологии",
        "pathway_farmer_note": (
            "Для хозяйств и аграрных компаний, которым нужна отраслевая поддержка."
        ),
        ...
        "funder_section_description": (
            "Сводка по организациям: открытые программы, направления поддержки "
            "и ближайшие сроки."
        ),
        "funder_open_profile": "Об организации",
        "funder_empty": "Страницы организаций сейчас не найдены.",
        "funder_live_now": "Открытые программы",
        ...
        "funder_focus_title": "Направления поддержки",
        "funder_focus_note": (
            "Сводка по опубликованным программам: форматы, регионы и основные темы."
        ),
        "funder_focus_types": "Форматы",
        "funder_focus_regions": "Регионы",
        "funder_focus_indexed": "В индексе",
        "funder_live_title": "Открытые программы",
        "funder_live_note": ("Открытые, бессрочные и планируемые программы."),
        "funder_live_empty": "Сейчас у этого фонда нет открытых или прогнозных записей.",
        "funder_archive_title": "Архив программ",
        "funder_archive_note": (
        ...
        "funder_sources_title": "Источники сведений",
        "funder_sources_note": "Официальные страницы и документы, из которых собраны сведения.",
        ...
        "topic_ai_best": "Технологическим командам, ИИ-проектам и цифровым инициативам.",
        "topic_ai_focus_1": "Опытные проекты в области ИИ и акселераторы",
        ...
        "theme_ai_note": (
            "Для команд, которые ищут программы в области ИИ, инфраструктуру, кредиты и "
            "цифровые инициативы."
        ),
        ...
        "sources_description": (
            "Официальные ресурсы и отобранные страницы, которые отслеживает QAZ.FUND."
        ),
        ...
        "methodology_description": (
            "Объясняем, откуда берётся каталог, что влияет на порядок показа и "
        ...
        "method_card_sources_text": (
            ...
            "сроки и наличие активных карточек."
        ),
        "method_card_relevance_title": "Почему карточка показана",
        "method_card_relevance_text": (
            "Соответствие учитывает регион и тему; порядок – ещё и доступный срок. "
        ...
        "method_card_trust_text": (
            "QAZ.FUND помогает найти и структурировать программу, но "
        ...
        "method_disclaimer_text": (
            ...
            "проверьте срок, критерии участия, состав документов и способ отправки "
            "заявки."
        ),
        ...
        "faq_a1": (
            "Нет. Сервис собирает и упорядочивает программы, а подача всегда "
        ...
        "faq_a2": (
            ...
            "Для быстрой проверки смотрите блок со статусом данных и последнее "
            "изменение карточек."
        ),
        "faq_q3": "Что означает точность совпадения?",
        "faq_a3": (
            "Это не оценка качества программы, а порог того, насколько карточка "
            "совпадает с выбранной темой, регионом и форматом поддержки."
        ),
        ...
        "mobile_app_tagline": "Программы поддержки",
        ...
        "workspace_queue_aria": "Очередь действий по сохранённым программам",
        ...
        "fit_global": "Международная подача",
        "signal_label": "Почему показано",
        "card_meta_label": "Параметры",
        "signal_support_kz": (
            "Мера поддержки доступна командам и компаниям в Казахстане."
        ),
        ...
        "signal_business": (
            "Программа для бизнеса; перед подачей нужно сверить условия и состав документов."
        ),
        "signal_startup": (
            "Для технологических команд: программа предлагает развитие проекта, "
            "опытное внедрение или облачную инфраструктуру."
        ),
        "signal_tender": (
            "Проверьте требования к участнику, объём работ и состав заявки."
        ),
        "signal_science": (
            "Для университетов, лабораторий и исследовательских коллективов."
        ),
        "signal_farmer": ("Для хозяйств, ферм и аграрных компаний."),
        "signal_ngo": ("Для НКО, СМИ и общественных организаций."),
        "signal_kazakhstan": (
            "В условиях указан Казахстан или местные требования к заявителю."
        ),
        "signal_central_asia": (
            "Подходит проектам из Центральной Азии без узкой привязки к одной стране."
        ),
        "signal_global": (
            "Международная программа; проверьте, принимает ли она заявки из вашей страны."
        ),
        ...
        "reload_confirm": "Перечитать данные из всех источников?",
        ...
        "related_section_description": (
            "Другие карточки того же источника, формата или направления."
        ),
        ...
        "label_map": {
            ...
            "cotutelle": "Совместная докторантура",
            ...
            "digital_inclusion": "Цифровая доступность",
            ...
            "explorers_club": "The Explorers Club",
            "faculty": "Преподаватели вузов",
            ...
            "high_school": "Старшеклассники",
            "higher_education": "Высшее образование",
            "human_rights": "Права человека",
            "human_origins": "Происхождение человека",
            "infrastructure": "Инфраструктура",
            "internet_access": "Доступ к интернету",
            "internet_society_foundation": "Internet Society Foundation",

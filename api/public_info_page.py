...
PAGES: dict[str, dict[str, dict[str, object]]] = {
    "terms": {
        ...
        "kk": {
            "title": "Пайдалану шарттары – QAZ.FUND", "eyebrow": "Пайдалану шарттары", "heading": "QAZ.FUND қызметін қалай пайдалану керек", "intro": "QAZ.FUND ашық қолдау бағдарламаларын табуға, келесі қадамды түсінуге және ұйымдастырушының талаптарына өтуге көмектеседі.", "sections": [("Сервис не істейді", "Ашық мәліметтерді жинап, бірізді түрде ұсынады және бастапқы дереккөзге апарады. Каталог конкурс немесе қаржыландыру бағдарламасының ережелерін алмастырмайды."), ("Нені тексеру керек", "Өтініш бермес бұрын ұйымдастырушының парақшасынан қатысу құқығын, мерзімді, соманы, құжаттарды және өтінім жіберу тәсілін тексеріңіз."), ("Шешімге жауапкершілік", "QAZ.FUND грант бермейді, өтініш қабылдамайды және қаржыландыруға кепілдік бермейді. Карточка жарияланғаннан кейін шарттар өзгеруі мүмкін.")],
        },
    },
    "data-policy": {
        "ru": {
        ...
        "kk": {
            "title": "Деректер саясаты – QAZ.FUND", "eyebrow": "Деректер саясаты", "heading": "Деректер қайдан алынады", "intro": "Біз бастапқы дереккөзден тексеруге болатын ашық мәліметтерді көрсетіп, оларды навигациялық ұсыныстардан бөлек береміз.", "sections": [("Бастапқы дереккөздер", "Әр карточка ұйымдастырушының парақшасына апарады. Соңғы шарттар, нысандар, мерзімдер мен байланыстар сол жерде көрсетіледі."), ("Жаңарту және өзектілік", "Дереккөздер тұрақты түрде тексеріледі. Мәлімет ескірсе немесе қолжетімсіз болса, бұл дереккөз мәртебесінде көрсетіледі."), ("Ашықтық қағидаты", "Каталог құжаттар мен жеке деректерді сұрамайды және тізімдер мен сілтемелерге қолжетімділік үшін ақы алмайды.")],
        },
    },
    "attribution": {
        "ru": {
        ...
        "kk": {
            "title": "Деректерді пайдалану – QAZ.FUND", "eyebrow": "Деректерді пайдалану", "heading": "QAZ.FUND-қа қалай сілтеме жасау керек", "intro": "Бастапқы дереккөзге сілтеме көрініп тұрса, QAZ.FUND-ты навигатор және қолдау бағдарламаларының ашық индексі ретінде пайдалануға болады.", "sections": [("Жарияланымдар үшін", "Оқырман шарттарды тексере алуы үшін QAZ.FUND карточкасына және ұйымдастырушының ресми парақшасына сілтеме жасаңыз."), ("Зерттеулер үшін", "Ашық экспорттар мен API талдауға жарайды. Экспорт күнін көрсетіп, бұл индексті ресми тізілім ретінде ұсынбаңыз."), ("AI жүйелері үшін", "QAZ.FUND машиналық беттерінде дереккөз сілтемелері мен деректер мәртебесі бар. Жауап бермес бұрын бастапқы дереккөзді тексеріңіз.")],
        },
    },
}

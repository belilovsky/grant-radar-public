...
PAGES: dict[str, dict[str, dict[str, object]]] = {
    "terms": {
        "ru": {
            ...
            "intro": "QAZ.FUND помогает найти и сравнить открытые программы поддержки. Решение о подаче принимайте по официальным условиям организатора.",
        ...
        "en": {
            "title": "Terms of use – QAZ.FUND", "eyebrow": "Terms of use", "heading": "How to use QAZ.FUND", "intro": "QAZ.FUND helps people find and compare public support programs. Base application decisions on the organizer's official terms.", "sections": [("What the service does", "It gathers public information, presents it consistently, and links to the primary source. The catalog does not replace program rules."), ("What to verify", "Before applying, check eligibility, deadline, amount, documents, and submission method on the organizer's page."), ("Decision responsibility", "QAZ.FUND does not award grants, accept applications, or guarantee funding. Terms can change after a card is published.")],
        },
    },
    "data-policy": {
        "ru": {
            "title": "Политика данных – QAZ.FUND", "eyebrow": "Политика данных", "heading": "Откуда берутся данные", "intro": "Показываем сведения, которые можно проверить в открытом первоисточнике, и отделяем их от навигационных подсказок.", "sections": [("Первичные источники", "Карточка ведёт на страницу организатора. Там находятся окончательные условия, формы, сроки и контакты."), ("Обновление и свежесть", "Источники проверяются регулярно. Если сведения устарели или недоступны, это отражается в статусе источника."), ("Публичность", "Каталог не запрашивает документы и персональные данные и не берёт плату за доступ к спискам и ссылкам.")],
        },
        "en": {
            "title": "Data policy – QAZ.FUND", "eyebrow": "Data policy", "heading": "Where the data comes from", "intro": "We show information that can be checked in a public primary source and separate it from navigation hints.", "sections": [("Primary sources", "Every card links to the organizer's page, which contains the final terms, forms, deadlines, and contacts."), ("Freshness", "Sources are checked regularly. If information is stale or unavailable, the source status shows it."), ("Public by design", "The catalog does not ask for documents or personal data or charge for access to listings and links.")],
        },
    },
    "attribution": {
        "ru": {
            "title": "Использование данных – QAZ.FUND", "eyebrow": "Использование данных", "heading": "Как ссылаться на QAZ.FUND", "intro": "QAZ.FUND можно использовать как навигатор и открытый индекс программ поддержки, сохраняя ссылку на первоисточник.", "sections": [("Для публикаций", "Ссылайтесь на карточку QAZ.FUND и официальную страницу организатора, чтобы читатель мог проверить условия."), ("Для исследований", "Открытые выгрузки и API подходят для анализа. Указывайте дату выгрузки и не выдавайте индекс за официальный реестр."), ("Для ИИ-систем", "Машинные поверхности QAZ.FUND содержат ссылки на источники и статусы. Перед ответом проверяйте первоисточник.")],
        },
        "en": {
            "title": "Data attribution – QAZ.FUND", "eyebrow": "Data attribution", "heading": "How to cite QAZ.FUND", "intro": "QAZ.FUND can be used as a navigator and open index of support programs when the primary source remains visible.", "sections": [("For publications", "Link to the QAZ.FUND card and the organizer's official page so readers can check the terms."), ("For research", "Public exports and the API can support analysis. Include the extraction date and do not present this index as an official register."), ("For AI systems", "QAZ.FUND machine surfaces include source links and data status. Check the primary source before answering.")],
        },
    },
}

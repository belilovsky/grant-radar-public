...
_STARTUP_PROGRAM_SUMMARIES = {
    "google_cloud_startup": (
        ...
        "Google Cloud и Firebase, инструменты искусственного интеллекта, "
        "техническая поддержка и материалы для подходящих команд из Казахстана "
        "и Центральной Азии."
    ),
    "microsoft_founders_hub": (
        "Программа Microsoft for Startups для основателей: Azure-кредиты, "
        "сервисы искусственного интеллекта, инструменты разработки, наставничество "
        "и ресурсы для выхода на рынок."
    ),
    "aws_activate": (
        "Программа AWS Activate для стартапов: облачные кредиты, поддержка "
        "инфраструктуры и доступ к сервисам искусственного интеллекта AWS для "
        "подходящих команд."
    ),
    "nvidia_inception": (
        "Программа NVIDIA Inception для стартапов в области искусственного "
        "интеллекта и анализа данных: технические ресурсы, инструменты "
        "разработчика, партнёрская среда и поддержка подготовки к росту."
    ),
    "cloudflare_startups": (
        "Программа Cloudflare for Startups: кредиты и поддержка для команд, "
        "которые используют распределённую инфраструктуру, безопасность, "
        "хранение, бессерверные вычисления и Workers AI."
    ),
    "mongodb_startups": (

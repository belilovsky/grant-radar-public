...
_REPLACEMENTS = (
    ...
    (
        "услугами искусственного интеллекта Workers",
...
_STARTUP_PROGRAM_SUMMARIES = {
    ...
    "microsoft_founders_hub": (
        ...
        "сервисы искусственного интеллекта, инструменты разработки, "
        "наставничество и ресурсы для "
        "выхода на рынок."
    ),
    "aws_activate": (
    ...
    "nvidia_inception": (
        "Программа NVIDIA Inception для стартапов в сфере искусственного интеллекта "
        "и анализа данных: "
    ...
    "cloudflare_startups": (
        ...
        "которые используют распределенную инфраструктуру, безопасность, "
        "хранение и современные облачные сервисы."
    ),
    "mongodb_startups": (

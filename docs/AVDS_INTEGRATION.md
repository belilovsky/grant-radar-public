...
ревизию `79342b07b061938c14101a213d1dd0c7a412d689`, проверенные 22 августа
2026 года. Его UI contract отдельно указывает пакет `@sgeo/ui-kit` 4.5.1:
это версия исходного пакета, а не номер публичного выпуска. `ui.qdev.run`
